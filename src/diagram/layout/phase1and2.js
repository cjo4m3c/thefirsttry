 ...
 *
 *   Phase 1: For each gateway condition, walk the priorities list under a
 ...
 *            上層先看 sibling 分散、路徑乾淨、規則 1 三個門檻；放寬順序為
 *            「保乾淨先放棄 sibling 分散」→「保 sibling 分散先放棄乾淨」→
 *            「都不滿足才走第一優先」。
 *
