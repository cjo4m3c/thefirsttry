 ...
 *
 * For each `X_g\d*` row, check that the expected predecessor exists AND
 * mentions this gateway number in its 任務關聯說明 (col 9). Any mismatch
 * is returned as a warning string so the UI can show it without blocking
 * import.
 */
