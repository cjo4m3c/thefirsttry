/**
 * Frozen changelog chunk 29 (2026-05-19 freeze point — current.js 衝到 49KB
 * 才凍結；之前 PR #218 起連續 11 條未凍結遠超 7KB 軟 cap）。
 * Re-exported from index.js after `current` and `c28`.
 */
export default [
  {
    date: '2026-05-18',
