/**
 * Changelog frozen chunk c26 — frozen 2026-05-06 from `current.js` after
 * PR #196 ship. Entries cover roughly 2026-05-05 後段 ~ 2026-05-06 的 PRs:
 * routing 升級三件組 ship、TaskCard col 2 chip + tooltip 重設計、Excel 匯入提醒文字 4
 * 項調整、頁面切換捲動置頂、ship-feature audit step、雙 bullet 修等。
 *
 * Entries are newest-first; do not edit frozen chunks (規則 PR-A 立過、不再修
 * 歷史條目）。
 */
export default [
  {
